...
const BlogsPage = () => {
  ...
  const posts = [
    { title: "10 SEO Strategies That Actually Work in 2025", category: "SEO", readTime: "8 min", color: "#0057FF", img: IMAGES.blog1 },
    { title: "How We Scaled a Brand to 1M Followers in 90 Days", category: "Social Media", readTime: "12 min", color: "#DB2777", img: IMAGES.blog2 },
    { title: "The Definitive Guide to Influencer ROI Measurement", category: "Influencer", readTime: "10 min", color: "#7C3AED", img: IMAGES.blog3 },
    { title: "PPC Bidding Strategies: A 2025 Playbook", category: "PPC", readTime: "7 min", color: "#FF6B1A", img: IMAGES.blog4 },
    { title: "Product Marketing vs Brand Marketing: The Difference?", category: "Growth Hacks", readTime: "6 min", color: "#059669", img: IMAGES.blog5 },
    { title: "Case Study: How We 3x'd a D2C Brand's Revenue", category: "Case Studies", readTime: "15 min", color: "#0057FF", img: IMAGES.blog6 },
  ];
  ...
  return (
    <div className="page-enter">
      ...
      <section className="section-pad" style={{ background: "#fff" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: "3.5rem", justifyContent: "center" }}>
            {categories.map(c => (
              <span key={c} style={{
                padding: "0.42rem 1rem", borderRadius: 30,
                border: "1.5px solid #dde3f0",
                fontFamily: "var(--font-display)", fontWeight: 700, fontSize: "0.73rem",
          ...
          <div className="blog-grid" style={{ marginBottom: "4rem" }}>
            {posts.map((post, i) => (
              <div key={i} className="card" style={{ cursor: "not-allowed", opacity: 0.75 }}>
                <img src={post.img} alt={post.title} className="placeholder-img"
                  style={{ height: 190, objectFit: "cover", borderRadius: "12px 12px 0 0" }} />
                <div style={{ padding: "1.4rem" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: "0.75rem" }}>
                    ...
                    <span style={{ display: "flex", alignItems: "center", gap: 4, fontSize: "0.72rem", color: "var(--grey)", fontWeight: 500 }}>
                      <Icon name="clock" size={11} color="var(--grey)" /> {post.readTime}
                    </span>
                  </div>
                  <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: "0.9rem", color: "var(--dark)", lineHeight: 1.45 }}>
                    {post.title}
                  </h3>
                </div>
              </div>
          ...
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 2 }}>
              <div style={{
                ...
                borderRadius: 30, padding: "0.35rem 0.9rem", marginBottom: "1.2rem",
              }}>
                <div style={{ width: 8, height: 8, borderRadius: "50%", background: "var(--orange)", animation: "pulse-ring 1.5s ease-out infinite" }} />
                <span style={{ fontFamily: "var(--font-display)", fontSize: "0.68rem", fontWeight: 800, color: "var(--orange-light)", letterSpacing: "0.1em" }}>
                  COMING SOON
                </span>
              </div>
              <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 900, fontSize: "clamp(1.4rem, 3vw, 1.9rem)", color: "#fff", marginBottom: "1rem" }}>
                Our Blog is Under Construction
              </h2>
              <p style={{ color: "rgba(255,255,255,0.7)", maxWidth: 460, margin: "0 auto 1.8rem", fontWeight: 400, fontSize: "0.93rem" }}>
              ...
              <div style={{ display: "flex", gap: 8, justifyContent: "center", maxWidth: 400, margin: "0 auto", flexWrap: "wrap" }}>
                <input type="email" placeholder="your@email.com" className="form-input"
                  style={{ flex: 1, minWidth: 200, cursor: "not-allowed" }} readOnly />
