    ...
    <nav style={{
      ...
      <div style={{
        ...
        <div onClick={() => setPage("Home")} style={{ cursor: "pointer", display: "flex", alignItems: "center", gap: 8 }}>
          <div style={{
            ...
            <span style={{ fontFamily: "var(--font-display)", fontWeight: 800, color: "#fff", fontSize: "1.2rem" }}>Y</span>
          </div>
          <span style={{
        ...
        <div className="desktop-nav" style={{ display: "flex", gap: "2rem", alignItems: "center" }}>
          {NAV_LINKS.map(link => (
            <span
              key={link}
              className={`nav-link ${activePage === link ? "active" : ""} ${!scrolled ? "nav-link-white" : ""}`}
      ...
      {mobileOpen && (
        <div style={{
          ...
          {NAV_LINKS.map(link => (
            <span key={link} className="nav-link" onClick={() => { setPage(link); setMobileOpen(false); }}>
              {link}
            </span>
          ))}
        </div>
...
/* ─────────────────────────────────────────────
   IMAGE PLACEHOLDER
───────────────────────────────────────────── */
const ImgPlaceholder = ({ label, gradient, height = 280, icon, aspectRatio }) => (
  <div style={{
    background: gradient || "linear-gradient(135deg, #0057FF22, #FF6B1A22)",
    borderRadius: 16,
    ...
    <div style={{
      ...
      {icon && <Icon name={icon} size={28} color="var(--blue)" />}
    </div>
    <span style={{ fontFamily: "var(--font-display)", fontSize: "0.8rem", color: "var(--grey)", fontWeight: 600 }}>
      {label}
    </span>
    {/* Decorative circles */}
    <div style={{ position: "absolute", top: -30, right: -30, width: 120, height: 120, borderRadius: "50%", background: "rgba(0,87,255,0.06)" }} />
    <div style={{ position: "absolute", bottom: -20, left: -20, width: 80, height: 80, borderRadius: "50%", background: "rgba(255,107,26,0.08)" }} />
  </div>
);
  ...
  return (
    <div className="page-enter">
      ...
      <section style={{
        ...
        <div ref={heroRef} style={{ maxWidth: 1200, margin: "0 auto", padding: "4rem 2rem", width: "100%", position: "relative", zIndex: 2 }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "center" }}>
            <div>
              <div className={`eyebrow ${heroVisible ? "animate-fade-up" : ""}`} style={{ color: "#FF8C4D", marginBottom: "1.2rem" }}>
                <span style={{ background: "none" }}>Mumbai's #1 Digital Marketing Agency</span>
              </div>

              <h1
                className={heroVisible ? "animate-fade-up delay-1" : ""}
                style={{
              ...
              <p
                className={heroVisible ? "animate-fade-up delay-2" : ""}
                style={{
                  fontSize: "1.1rem", lineHeight: 1.7, color: "rgba(255,255,255,0.65)",
              ...
              <div
                className={heroVisible ? "animate-fade-up delay-3" : ""}
              ...
              >
                ...
                <button className="btn-primary btn-outline" style={{ borderColor: "rgba(255,255,255,0.3)", color: "#fff" }} onClick={() => setPage("Contact")}>
                  Talk to Us
                </button>
              </div>
              ...
              <div style={{ display: "flex", gap: 8, marginTop: "2rem", flexWrap: "wrap" }}>
                {services.map(s => (
                  <div key={s.label} style={{
                    ...
                    padding: "0.4rem 0.9rem", border: "1px solid rgba(255,255,255,0.12)",
                  }}>
                    <Icon name={s.icon} size={13} color={s.color} />
                    <span style={{ fontFamily: "var(--font-display)", fontSize: "0.72rem", fontWeight: 600, color: "rgba(255,255,255,0.75)" }}>
                      {s.label}
                    </span>
                  </div>
                ))}
            ...
            {/* Hero visual */}
            <div className={`animate-float ${heroVisible ? "animate-fade-in" : ""}`} style={{ opacity: heroVisible ? undefined : 0 }}>
              <div style={{
                background: "rgba(255,255,255,0.04)",
                borderRadius: 24, border: "1px solid rgba(255,255,255,0.1)",
                padding: "2rem", position: "relative",
              }}>
                <ImgPlaceholder label="Campaign Dashboard" height={360} icon="ppc"
                  gradient="linear-gradient(135deg, rgba(0,87,255,0.15), rgba(255,107,26,0.1))" />

                {/* Floating metric cards */}
                <div style={{
                  position: "absolute", top: -20, left: -20,
                  background: "#fff", borderRadius: 12, padding: "0.8rem 1.2rem",
                  boxShadow: "0 8px 32px rgba(0,0,0,0.15)",
                  display: "flex", alignItems: "center", gap: 10,
                }}>
                  <div style={{ width: 36, height: 36, borderRadius: 8, background: "#e8f0ff", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <Icon name="ppc" size={18} color="var(--blue)" />
                  </div>
                  <div>
                    <div style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "1.1rem", color: "var(--blue)" }}>+247%</div>
                    <div style={{ fontSize: "0.7rem", color: "var(--grey)", fontWeight: 500 }}>ROI Increase</div>
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{ width: 36, height: 36, borderRadius: 8, background: "#fff3ee", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <Icon name="influencer" size={18} color="var(--orange)" />
                  </div>
                  <div>
                    <div style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "1.1rem", color: "var(--orange)" }}>5M+</div>
                    <div style={{ fontSize: "0.7rem", color: "var(--grey)", fontWeight: 500 }}>Reach Generated</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div style={{ position: "absolute", bottom: 32, left: "50%", transform: "translateX(-50%)", display: "flex", flexDirection: "column", alignItems: "center", gap: 6 }}>
          <span style={{ fontFamily: "var(--font-display)", fontSize: "0.65rem", letterSpacing: "0.15em", color: "rgba(255,255,255,0.4)", textTransform: "uppercase" }}>Scroll</span>
          <div style={{
      ...
      {/* ── MARQUEE ── */}
      <div style={{ background: "var(--orange)", padding: "0.9rem 0", overflow: "hidden" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "2rem", textAlign: "center" }}>
            {[
              ...
              <div key={i} style={{ padding: "2rem 1rem" }}>
                ...
                <div style={{ fontFamily: "var(--font-display)", fontWeight: 600, fontSize: "0.85rem", color: "var(--grey)", marginTop: "0.5rem", letterSpacing: "0.04em" }}>
                  {stat.label}
                </div>
              </div>
            ))}
      ...
      <section style={{ padding: "6rem 2rem", background: "#fff" }}>
        <div ref={aboutRef} style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "5rem", alignItems: "center" }}>
          <div>
            <ImgPlaceholder label="Our Story" height={420} icon="social"
              gradient="linear-gradient(135deg, #e8f0ff, #fff3ee)" aspectRatio="4/5" />
          </div>
          <div>
            <div className={`eyebrow ${aboutVisible ? "animate-fade-up" : ""}`} style={{ marginBottom: "1rem", opacity: aboutVisible ? 1 : 0 }}>
              About Ydigital
            </div>
            ...
            <p style={{ color: "var(--grey)", lineHeight: 1.8, marginBottom: "1.5rem", fontSize: "1rem" }}>
            ...
            <p style={{ color: "var(--grey)", lineHeight: 1.8, marginBottom: "2rem", fontSize: "1rem" }}>
            ...
            {[
              ...
              <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 10, marginBottom: "0.8rem" }}>
                ...
                <span style={{ fontFamily: "var(--font-display)", fontWeight: 600, fontSize: "0.9rem", color: "var(--dark)" }}>{item}</span>
              </div>
            ))}
        ...
        <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", zIndex: 2 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1.5rem" }}>
            {[
              ...
              { icon: "influencer", title: "Influencer Marketing", desc: "Scale reach authentically.", color: "#A78BFA" },
              ...
              <div key={i} className="card" onClick={() => setPage("Services")} style={{
                ...
                <div style={{ width: 50, height: 50, borderRadius: 12, background: `${s.color}22`, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "1rem" }}>
                  <Icon name={s.icon} size={22} color={s.color} />
                </div>
                <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: "1rem", color: "#fff", marginBottom: "0.4rem" }}>{s.title}</h3>
      ...
      {/* ── TESTIMONIALS ── */}
      <section style={{ padding: "6rem 2rem", background: "var(--off-white)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "1.5rem" }}>
            {[
              ...
              { text: "The PPC campaigns they ran for us had the best ROI we've ever seen. Truly data-driven experts.", name: "Priya Mehta", role: "Marketing Director", rating: 5 },
              ...
              <div key={i} className="card" style={{ padding: "2rem" }}>
                <div style={{ display: "flex", gap: 3, marginBottom: "1rem" }}>
                  {Array(t.rating).fill(0).map((_, j) => <Icon key={j} name="star" size={14} color="var(--orange)" />)}
                </div>
                <p style={{ color: "var(--grey)", lineHeight: 1.7, marginBottom: "1.5rem", fontStyle: "italic" }}>"{t.text}"</p>
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  <div style={{ width: 42, height: 42, borderRadius: "50%", background: "linear-gradient(135deg, #0057FF, #FF6B1A)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <span style={{ fontFamily: "var(--font-display)", fontWeight: 800, color: "#fff", fontSize: "0.9rem" }}>{t.name[0]}</span>
                  </div>
                  <div>
                    <div style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: "0.9rem", color: "var(--dark)" }}>{t.name}</div>
                    <div style={{ fontSize: "0.78rem", color: "var(--grey)" }}>{t.role}</div>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section style={{
        ...
        <div style={{ position: "relative", zIndex: 2 }}>
          <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "clamp(1.8rem, 4vw, 2.8rem)", color: "#fff", marginBottom: "1rem" }}>
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{
          ...
          <div style={{
            ...
            <ImgPlaceholder label={service.img} height={380} icon={service.icon} gradient={service.bg} aspectRatio="4/3" />
          </div>
          ...
          <div style={{
            ...
            <p style={{ color: "var(--grey)", lineHeight: 1.8, marginBottom: "1.8rem", fontSize: "0.97rem" }}>
              {service.desc}
            </p>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.6rem", marginBottom: "2rem" }}>
              {service.bullets.map((b, i) => (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <span style={{ fontSize: "0.9rem", color: "var(--dark)", fontWeight: 500 }}>{b}</span>
                </div>
              ))}
            </div>
            ...
            <div style={{
              ...
              <div style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "2rem", color: service.color }}>
                {service.metric}
              </div>
              <div style={{ fontSize: "0.82rem", color: "var(--grey)", maxWidth: 110, lineHeight: 1.3, fontWeight: 500 }}>
                {service.metricLabel}
              </div>
            </div>
          </div>
...
const ServicesPage = ({ setPage }) => (
  <div className="page-enter">
    {/* Header */}
    <section style={{
      background: "var(--dark)", padding: "10rem 2rem 5rem",
      ...
      <div style={{ position: "relative", zIndex: 2 }}>
        ...
        <p className="animate-fade-up delay-2" style={{ color: "rgba(255,255,255,0.6)", fontSize: "1.05rem", maxWidth: 560, margin: "0 auto 2rem" }}>
        ...
        <div style={{ display: "flex", justifyContent: "center", gap: 8, flexWrap: "wrap" }}>
          {services.map(s => (
            <div key={s.id} style={{
              display: "flex", alignItems: "center", gap: 6,
              background: "rgba(255,255,255,0.07)", borderRadius: 30,
              padding: "0.45rem 1rem", border: "1px solid rgba(255,255,255,0.1)",
            }}>
              <Icon name={s.icon} size={12} color={s.color} />
              <span style={{ fontFamily: "var(--font-display)", fontSize: "0.72rem", fontWeight: 700, color: "rgba(255,255,255,0.75)", textTransform: "uppercase", letterSpacing: "0.06em" }}>{s.title.split(" ")[0]}</span>
            </div>
          ))}
        </div>
      </div>
    ...
    {/* Why Us */}
    <section style={{ padding: "6rem 2rem", background: "var(--blue)", position: "relative", overflow: "hidden" }}>
      <div className="orb" style={{ width: 350, height: 350, background: "rgba(255,255,255,0.1)", top: -80, right: -60 }} />
      <div style={{ maxWidth: 1200, margin: "0 auto", position: "relative", zIndex: 2 }}>
        <div style={{ textAlign: "center", marginBottom: "4rem" }}>
          <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "clamp(1.8rem, 3.5vw, 2.8rem)", color: "#fff", marginBottom: "0.8rem" }}>
            Why Ydigital?
          </h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "1.5rem" }}>
          {[
            ...
            <div key={i} style={{
              ...
              <div style={{ width: 44, height: 44, borderRadius: 10, background: "rgba(255,255,255,0.15)", display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "1rem" }}>
                <Icon name={w.icon} size={20} color="#fff" />
              </div>
              <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 700, color: "#fff", fontSize: "1rem", marginBottom: "0.5rem" }}>{w.title}</h3>
              <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "0.88rem", lineHeight: 1.6 }}>{w.desc}</p>
            </div>
          ))}
        </div>
        <div style={{ textAlign: "center", marginTop: "3rem" }}>
...
/* ─────────────────────────────────────────────
   BLOGS PAGE (Future Scope)
───────────────────────────────────────────── */
const BlogsPage = () => {
  const categories = ["SEO", "PPC", "Social Media", "Influencer", "Growth Hacks", "Case Studies"];
  ...
  return (
    <div className="page-enter">
      <section style={{
        ...
        <div className="orb" style={{ width: 500, height: 500, background: "rgba(0,87,255,0.12)", top: -150, left: "20%" }} />
        <div style={{ position: "relative", zIndex: 2 }}>
          <div className="eyebrow animate-fade-up" style={{ justifyContent: "center", color: "var(--orange-light)", marginBottom: "1rem" }}>Ydigital Blog</div>
          <h1 className="section-title animate-fade-up delay-1" style={{ color: "#fff", marginBottom: "1rem" }}>
            Insights & <span>Ideas</span>
          </h1>
          <p style={{ color: "rgba(255,255,255,0.6)", maxWidth: 500, margin: "0 auto" }}>
            Deep dives into digital marketing, growth hacks, and campaign case studies — coming soon.
          </p>
        </div>
      </section>
      ...
      <section style={{ padding: "5rem 2rem", background: "#fff" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          {/* Category filters */}
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: "4rem", justifyContent: "center" }}>
            {categories.map(c => (
              <span key={c} style={{
                padding: "0.45rem 1.1rem", borderRadius: 30,
                border: "1.5px solid #dde3f0",
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "1.5rem", marginBottom: "4rem" }}>
            {[
              { title: "10 SEO Strategies That Actually Work in 2025", category: "SEO", readTime: "8 min", color: "#0057FF" },
              { title: "How We Scaled a Brand to 1M Followers in 90 Days", category: "Social Media", readTime: "12 min", color: "#DB2777" },
              { title: "The Definitive Guide to Influencer ROI Measurement", category: "Influencer", readTime: "10 min", color: "#7C3AED" },
              { title: "PPC Bidding Strategies: A 2025 Playbook", category: "PPC", readTime: "7 min", color: "#FF6B1A" },
              { title: "Product Marketing vs Brand Marketing: What's the Difference?", category: "Growth Hacks", readTime: "6 min", color: "#059669" },
              { title: "Case Study: How We 3x'd a D2C Brand's Revenue", category: "Case Studies", readTime: "15 min", color: "#0057FF" },
            ].map((post, i) => (
              <div key={i} className="card" style={{ cursor: "not-allowed", opacity: 0.7 }}>
                <ImgPlaceholder label="Blog Cover Image" height={180} gradient={`linear-gradient(135deg, ${post.color}15, ${post.color}08)`} />
                <div style={{ padding: "1.5rem" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: "0.8rem" }}>
                    ...
                    <span style={{ display: "flex", alignItems: "center", gap: 4, fontSize: "0.75rem", color: "var(--grey)" }}>
                      <Icon name="clock" size={12} color="var(--grey)" /> {post.readTime}
                    </span>
                  </div>
                  <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: "0.95rem", color: "var(--dark)", lineHeight: 1.4 }}>
                    {post.title}
                  </h3>
                </div>
              </div>
          ...
          <div style={{
            ...
            <div className="orb" style={{ width: 200, height: 200, background: "rgba(255,255,255,0.08)", top: -60, right: "10%" }} />
            <div style={{ position: "relative", zIndex: 2 }}>
              <div style={{
                display: "inline-flex", alignItems: "center", gap: 8,
                background: "rgba(255,107,26,0.25)", border: "1px solid rgba(255,107,26,0.4)",
                borderRadius: 30, padding: "0.4rem 1rem", marginBottom: "1.2rem",
              }}>
                <div style={{ width: 8, height: 8, borderRadius: "50%", background: "var(--orange)", animation: "pulse-ring 1.5s ease-out infinite" }} />
                <span style={{ fontFamily: "var(--font-display)", fontSize: "0.72rem", fontWeight: 700, color: "var(--orange-light)", letterSpacing: "0.1em" }}>
                  COMING SOON
                </span>
              </div>
              <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "1.8rem", color: "#fff", marginBottom: "1rem" }}>
                Our Blog is Under Construction
              </h2>
              <p style={{ color: "rgba(255,255,255,0.7)", maxWidth: 480, margin: "0 auto 1.8rem" }}>
                We're working on bringing you expert insights, marketing playbooks, and real campaign case studies. Subscribe to be notified when we go live.
              </p>
              <div style={{ display: "flex", gap: 8, justifyContent: "center", maxWidth: 400, margin: "0 auto" }}>
                <input type="email" placeholder="your@email.com" className="form-input" style={{ flex: 1, cursor: "not-allowed" }} readOnly />
                <button className="btn-primary btn-orange">Notify Me</button>
              </div>
            </div>
          </div>
        </div>
...
const faqs = [
  ...
  { q: "What makes Ydigital different from other digital marketing agencies?", a: "We combine deep data analytics with genuine creative strategy. We don't use cookie-cutter playbooks — every campaign is built from scratch for your brand. Plus, you always have a dedicated account manager who knows your business." },
...
const FAQsPage = () => {
  ...
  return (
    <div className="page-enter">
      {/* Header */}
      <section style={{ background: "var(--dark)", padding: "10rem 2rem 5rem", textAlign: "center", position: "relative", overflow: "hidden" }}>
      ...
      {/* Main content: FAQ + Form side by side */}
      <section style={{ padding: "5rem 2rem", background: "#fff" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: "4rem", alignItems: "flex-start" }}>

          {/* FAQ list */}
          <div>
            <div className="eyebrow" style={{ marginBottom: "1rem" }}>Common Questions</div>
            <h2 className="section-title" style={{ marginBottom: "2.5rem", fontSize: "2rem" }}>
          ...
          <div style={{ position: "sticky", top: 90 }}>
            <div style={{
              background: "var(--off-white)", borderRadius: 20, padding: "2.5rem",
              border: "1px solid #e8edf5",
            }}>
              <div className="eyebrow" style={{ marginBottom: "0.8rem" }}>Ask Us Anything</div>
              <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "1.5rem", color: "var(--dark)", marginBottom: "0.5rem" }}>
                Send Your Query
              </h3>
              <p style={{ color: "var(--grey)", fontSize: "0.9rem", marginBottom: "1.8rem", lineHeight: 1.6 }}>
              ...
              {submitted ? (
                <div style={{
                  ...
                  <p style={{ color: "var(--grey)", fontSize: "0.85rem", marginTop: "0.3rem" }}>We'll get back to you within 24 hours.</p>
                </div>
              ) : (
              ...
              {/* Quick contact */}
              <div style={{ marginTop: "2rem", paddingTop: "1.5rem", borderTop: "1px solid #e8edf5" }}>
                <p style={{ fontSize: "0.82rem", color: "var(--grey)", marginBottom: "0.8rem", fontWeight: 500 }}>Prefer to talk directly?</p>
                <div style={{ display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                  <a href="tel:+918591261258" style={{ display: "flex", alignItems: "center", gap: 8, color: "var(--blue)", fontFamily: "var(--font-display)", fontWeight: 600, fontSize: "0.85rem", textDecoration: "none" }}>
                    <Icon name="phone" size={14} color="var(--blue)" /> +91 85912 61258
                  </a>
                  <a href="mailto:ydigital@gmail.com" style={{ display: "flex", alignItems: "center", gap: 8, color: "var(--blue)", fontFamily: "var(--font-display)", fontWeight: 600, fontSize: "0.85rem", textDecoration: "none" }}>
...
const ContactPage = () => {
  ...
  return (
    <div className="page-enter">
      ...
      {/* Contact info + form */}
      <section style={{ padding: "5rem 2rem", background: "#fff" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1.5fr", gap: "4rem", alignItems: "flex-start" }}>

          {/* Info */}
          <div>
            <div className="eyebrow" style={{ marginBottom: "1rem" }}>Contact Info</div>
            <h2 style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "1.8rem", color: "var(--dark)", marginBottom: "0.5rem" }}>
              We're Ready When You Are
            </h2>
            <p style={{ color: "var(--grey)", lineHeight: 1.7, marginBottom: "2.5rem" }}>
            ...
            {[
              ...
              <div key={i} style={{ display: "flex", gap: 16, marginBottom: "1.5rem", alignItems: "flex-start" }}>
                <div style={{
                ...
                <div>
                  <div style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: "0.78rem", color: "var(--grey)", textTransform: "uppercase", letterSpacing: "0.06em", marginBottom: "0.2rem" }}>{item.label}</div>
                  {item.href ? (
                    <a href={item.href} style={{ color: "var(--dark)", fontWeight: 500, fontSize: "0.95rem", textDecoration: "none" }}>{item.value}</a>
                  ) : (
                    <span style={{ color: "var(--dark)", fontWeight: 500, fontSize: "0.95rem" }}>{item.value}</span>
                  )}
                </div>
              </div>
            ))}
            ...
            {/* Map placeholder */}
            <ImgPlaceholder label="Mumbai, India — Khar Office" height={200} icon="location"
              gradient="linear-gradient(135deg, #e8f0ff, #f0f5ff)" />
          </div>

          {/* Form */}
          <div style={{ background: "var(--off-white)", borderRadius: 20, padding: "2.5rem", border: "1px solid #e8edf5" }}>
            <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 800, fontSize: "1.5rem", color: "var(--dark)", marginBottom: "0.4rem" }}>
            ...
            {submitted ? (
              <div style={{ background: "#ecfdf5", border: "1px solid #6ee7b7", borderRadius: 12, padding: "2rem", textAlign: "center" }}>
                ...
                <div style={{ fontFamily: "var(--font-display)", fontWeight: 700, color: "#059669", fontSize: "1.1rem" }}>Message Sent!</div>
                <p style={{ color: "var(--grey)", fontSize: "0.88rem", marginTop: "0.4rem" }}>Our team will reach out within 24 hours.</p>
              </div>
            ) : (
              <div style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
                  ...
                  <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
                    {budgets.map(b => (
                      <button key={b} onClick={() => setFormData({ ...formData, budget: b })}
                        style={{
                          padding: "0.45rem 0.9rem", borderRadius: 30,
                ...
                <div>
                  ...
                  <textarea className="form-input" rows={4}
                    placeholder="What are you trying to achieve? What's your timeline? Any specifics help..."
                    value={formData.message} onChange={e => setFormData({ ...formData, message: e.target.value })}
                    style={{ resize: "vertical" }} />
                </div>
      ...
      {/* Footer */}
      <footer style={{ background: "var(--dark-2)", padding: "4rem 2rem 2rem", color: "rgba(255,255,255,0.6)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr 1.2fr", gap: "3rem", marginBottom: "3rem" }}>
            {/* Brand */}
            <div>
              <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: "1rem" }}>
                <div style={{ width: 38, height: 38, borderRadius: 8, background: "linear-gradient(135deg, #0057FF, #4D8FFF)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <span style={{ fontFamily: "var(--font-display)", fontWeight: 800, color: "#fff", fontSize: "1.2rem" }}>Y</span>
                </div>
                <span style={{ fontFamily: "var(--font-display)", fontWeight: 800, color: "#fff", fontSize: "1.2rem" }}>digital</span>
              </div>
              <p style={{ fontSize: "0.88rem", lineHeight: 1.7, maxWidth: 280 }}>
                Mumbai's top-rated digital marketing agency. We engineer growth that compounds — for brands that want to lead, not follow.
              </p>
              <div style={{ display: "flex", gap: 10, marginTop: "1.5rem" }}>
                {["Twitter", "LinkedIn", "Instagram", "Facebook"].map(s => (
                  ...
                  >
                    <span style={{ fontSize: "0.65rem", color: "rgba(255,255,255,0.5)", fontFamily: "var(--font-display)", fontWeight: 700 }}>{s[0]}</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            {/* Services */}
            <div>
              <h4 style={{ fontFamily: "var(--font-display)", fontWeight: 700, color: "#fff", fontSize: "0.85rem", marginBottom: "1.2rem", letterSpacing: "0.06em", textTransform: "uppercase" }}>Services</h4>
              {["SEO", "PPC Management", "Influencer Mktg", "Product Mktg", "Social Media"].map(s => (
                <div key={s} style={{ marginBottom: "0.6rem", fontSize: "0.88rem", cursor: "pointer", transition: "color 0.2s" }}
                  onMouseEnter={e => e.currentTarget.style.color = "#fff"}
                  onMouseLeave={e => e.currentTarget.style.color = "rgba(255,255,255,0.6)"}>{s}</div>
              ))}
            </div>

            {/* Company */}
            <div>
              <h4 style={{ fontFamily: "var(--font-display)", fontWeight: 700, color: "#fff", fontSize: "0.85rem", marginBottom: "1.2rem", letterSpacing: "0.06em", textTransform: "uppercase" }}>Company</h4>
              {["Home", "Services", "Blogs", "FAQs", "Contact Us"].map(s => (
                <div key={s} style={{ marginBottom: "0.6rem", fontSize: "0.88rem", cursor: "pointer", transition: "color 0.2s" }}
                  onMouseEnter={e => e.currentTarget.style.color = "#fff"}
                  onMouseLeave={e => e.currentTarget.style.color = "rgba(255,255,255,0.6)"}>{s}</div>
              ))}
            ...
            {/* Contact */}
            <div>
              <h4 style={{ fontFamily: "var(--font-display)", fontWeight: 700, color: "#fff", fontSize: "0.85rem", marginBottom: "1.2rem", letterSpacing: "0.06em", textTransform: "uppercase" }}>Contact</h4>
              <div style={{ display: "flex", flexDirection: "column", gap: "0.8rem" }}>
                {[
                  { icon: "location", val: "Khar, Mumbai, Maharashtra" },
                  { icon: "mail", val: "ydigital@gmail.com" },
                  { icon: "phone", val: "+91 85912 61258" },
                  { icon: "clock", val: "Mon–Sat, 9AM–6PM" },
                ].map((c, i) => (
                  <div key={i} style={{ display: "flex", gap: 8, alignItems: "flex-start" }}>
                    <Icon name={c.icon} size={14} color="var(--orange)" />
                    <span style={{ fontSize: "0.85rem", lineHeight: 1.4 }}>{c.val}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: "1.5rem", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "1rem" }}>
            <span style={{ fontSize: "0.82rem" }}>© 2025 Ydigital by <strong style={{ color: "var(--blue-light)" }}>4Aesthetique Solutions</strong>. All rights reserved.</span>
            <div style={{ display: "flex", gap: "1.5rem" }}>
              {["Privacy Policy", "Terms of Service"].map(l => (
                <span key={l} style={{ fontSize: "0.8rem", cursor: "pointer", transition: "color 0.2s" }}
                  onMouseEnter={e => e.currentTarget.style.color = "#fff"}
                  onMouseLeave={e => e.currentTarget.style.color = "rgba(255,255,255,0.6)"}>{l}</span>
              ))}
            </div>
          </div>
        </div>
  ...
  return (
    <>
      ...
      <div ref={topRef} style={{ minHeight: "100vh" }}>
        ...
        {/* Footer always shown on non-contact pages */}
        {activePage !== "Contact" && (
          <footer style={{ background: "var(--dark-2)", padding: "4rem 2rem 2rem", color: "rgba(255,255,255,0.6)" }}>
            <div style={{ maxWidth: 1200, margin: "0 auto" }}>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "2rem", marginBottom: "2.5rem" }}>
                <div>
                  <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: "1rem" }}>
                    <div style={{ width: 34, height: 34, borderRadius: 8, background: "linear-gradient(135deg, #0057FF, #4D8FFF)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <span style={{ fontFamily: "var(--font-display)", fontWeight: 800, color: "#fff", fontSize: "1rem" }}>Y</span>
                    </div>
                    <span style={{ fontFamily: "var(--font-display)", fontWeight: 800, color: "#fff", fontSize: "1.1rem" }}>digital</span>
                  </div>
                  <p style={{ fontSize: "0.83rem", lineHeight: 1.65, maxWidth: 240 }}>
                ...
                {[
                  ...
                  <div key={col.title}>
                    <h4 style={{ fontFamily: "var(--font-display)", fontWeight: 700, color: "#fff", fontSize: "0.8rem", marginBottom: "1.1rem", letterSpacing: "0.06em", textTransform: "uppercase" }}>{col.title}</h4>
                    {col.links.map(l => (
                      <div key={l} onClick={() => col.title === "Company" && setPage(l.replace(" Us", ""))}
                        style={{ marginBottom: "0.55rem", fontSize: "0.85rem", cursor: col.title === "Company" ? "pointer" : "default", transition: "color 0.2s" }}
                        onMouseEnter={e => { if (col.title === "Company") e.currentTarget.style.color = "#fff"; }}
                        onMouseLeave={e => { if (col.title === "Company") e.currentTarget.style.color = "rgba(255,255,255,0.6)"; }}>{l}</div>
                    ))}
                  </div>
                ))}
              </div>
              <div style={{ borderTop: "1px solid rgba(255,255,255,0.08)", paddingTop: "1.5rem", textAlign: "center" }}>
                <span style={{ fontSize: "0.8rem" }}>© 2025 Ydigital by <strong style={{ color: "var(--blue-light)" }}>4Aesthetique Solutions</strong>. All rights reserved.</span>
              </div>
            </div>
          </footer>
        )}
